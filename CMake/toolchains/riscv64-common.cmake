...
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -ffreestanding -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL} -fno-stack-protector")
set(CMAKE_C_FLAGS_RELEASE "${CMAKE_C_FLAGS_RELEASE} -mexplicit-relocs")
