...
set(CMAKE_C_COMPILER_TARGET riscv64-linux-gnu-elf)

set(RISCV_LINKER_FLAGS "${RISCV_LINKER_FLAGS} -nostdlib")

set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -ffreestanding -fno-stack-protector -fno-stack-check -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL}")
