...
set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -fPIC -fpic")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -ffreestanding -march=${RISCV_ARCH} -mabi=${RISCV_ABI} -mcmodel=${RISCV_CMODEL} -fno-stack-protector -fPIC -fpic")
