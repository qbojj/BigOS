 ...
 *
 *  Project:		BigOS
 *  File:			bootloader/elf/elf_defines.h
 *  Description:	Standard ELF file definitions.
 *
 ******************************************************************************/

#ifndef BIGOS_BOOTLOADER_ELF_ELF_DEFINES
#define BIGOS_BOOTLOADER_ELF_ELF_DEFINES 1
...
#endif // !BIGOS_BOOTLOADER_ELF_ELF_DEFINES
